            ...
            <div className="columns">
              ...
              <div className="column">
                ...
                <div className="columns">
                  <div className="column">
                    { cont.previous ? (
                      <a href={`/guides/${cont.previous.path}`} className="button is-fullwidth is-outlined is-info">
                        <span className="icon">
                  ...
                  <div className="column">
                    { cont.next ? (
                      <a href={`/guides/${cont.next.path}`} className="button is-fullwidth is-outlined is-info">
