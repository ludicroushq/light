        ...
        <div className="flex items-center justify-between flex-wrap container mx-auto">
          ...
          <div className={classnames('w-full block flex-grow md:flex md:items-center md:w-auto', { 'hidden': !active })}>
            ...
            <div>
              ...
              <a href="https://lightjs.gitbook.io/light/guides/getting-started" className={classnames('block mt-4 md:inline-block md:mt-0 uppercase mr-4', route.includes('/guides') ? 'text-indigo-400 font-medium' : 'text-gray-700 hover:text-black')} role="navigation" onClick={this.closeMenu}>
                Guides
              </a>
              <a href="https://lightjs.gitbook.io/light/api/server" className={classnames('block mt-4 md:inline-block md:mt-0 uppercase mr-4', route.includes('/docs') ? 'text-indigo-400 font-medium' : 'text-gray-700 hover:text-black')} role="navigation" onClick={this.closeMenu}>
                Docs
              </a>
            </div>
          </div>
