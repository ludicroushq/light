...
describe('pino pretty', () => {
  ...
  describe('with req and res objects', () => {
    ...
    describe('status codes', () => {
      describe('with 200 status code', () => {
        beforeAll(() => {
          input = { v: 1, req: {}, res: { statusCode: 200 }, msg: 'light' }
        })
      ...
      describe('with 300 status code', () => {
        beforeAll(() => {
          input = { v: 1, req: {}, res: { statusCode: 300 }, msg: 'light' }
        })
      ...
      describe('with 404 status code', () => {
        beforeAll(() => {
          input = { v: 1, req: {}, res: { statusCode: 404 }, msg: 'light' }
        })
      ...
      describe('with 500 status code', () => {
        beforeAll(() => {
          input = { v: 1, req: {}, res: { statusCode: 500 }, msg: 'light' }
        })
    ...
    describe('url', () => {
      describe('with a url', () => {
        beforeAll(() => {
          input = { v: 1, req: { method: 'GET', url: '/hello-world?test=true' }, res: { statusCode: 200 }, msg: 'light' }
        })
        it('returns a 200 message', () => {
          expect.assertions(1);
    ...
    describe('response time', () => {
      describe('with a response time', () => {
        beforeAll(() => {
          input = { v: 1, req: { method: 'GET', url: '/hello-world?test=true' }, res: { statusCode: 200 }, msg: 'light', responseTime: 1 }
        })
        it('returns a 200 message', () => {
          expect.assertions(1);
  ...
  describe('with string input', () => {
    beforeAll(() => {
      input = JSON.stringify({ v: 1, req: { method: 'GET', url: '/hello-world?test=true' }, res: { statusCode: 200 }, msg: 'light', responseTime: 1 });
    })
    it('returns a 200 message', () => {
      expect.assertions(1);
      expect(result).toBe(' GET  200 to /hello-world?test=true, light in 1 ms');
